                    ...
                    <div className='pt-[17px]'>
                        ...
                        <div className='px-[5px]'>
                            <div className='bg-[#B3C8E580] mt-[31px] rounded-[15px] px-[11px] pb-[11px]'>
                                ...
                                <input type="text" placeholder='Balance' className='border-[#1A4F8B] border-[1px] bg-white rounded-md p-[12px_8px] mt-[50px] mb-[50px] w-full' />
                                <label className='text-[16px] font-semibold block mb-2'>Password</label>
                                <div className='flex gap-5'>
                                    <input type="text" className='border-[#1A4F8B] border-[1px] bg-white rounded-md sm:p-[8px_27px] p-[8px_22px] sm:text-[20px] text-[18px] w-full outline-none' />
                                    <input type="text" className='border-[#1A4F8B] border-[1px] bg-white rounded-md sm:p-[8px_27px] p-[8px_22px] sm:text-[20px] text-[18px] w-full outline-none' />
                                    <input type="text" className='border-[#1A4F8B] border-[1px] bg-white rounded-md sm:p-[8px_27px] p-[8px_22px] sm:text-[20px] text-[18px] w-full outline-none' />
                                    <input type="text" className='border-[#1A4F8B] border-[1px] bg-white rounded-md sm:p-[8px_27px] p-[8px_22px] sm:text-[20px] text-[18px] w-full outline-none' />
                                </div>
                            ...
                            <div className='text-center mt-[40px]'>
                                <button className='bg-[#77A4F4] w-[310px] mx-auto text-white rounded-[15px] p-[15px]'>Save Changes</button>
                            </div>
                        </div>
                    </div>
                </div>
