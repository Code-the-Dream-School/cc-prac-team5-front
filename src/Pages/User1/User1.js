        ...
        <div className="h-[708px]">
          <div className="bg-bg100 bg-no-repeat pt-[56px] px-[12px]">
            <div className="flex justify-between items-center">
              <button className="bg-[#BCCEED] text-white font-bold text-[14px] rounded-[15px] w-[80px] h-[35px] flex justify-center items-center">
                Profiles
              </button>
              <button className="bg-[#BCCEED] text-white font-bold text-[14px] rounded-[15px] w-[80px] h-[35px] flex justify-center items-center">
                Sign Out
            ...
            <h1 className="text-[25px] font-bold text-center text-white mt-[10px]">
              Hi, User1
            </h1>
            <div className="px-[5px]">
              <div className="bg-[#B3C8E5D9] mt-[57px] rounded-xl p-[11px]">
                <h1 className="font-bold text-[20px] border-b-[#A5A5A5] border-b-[1px] text-center">
                  User1’s Chores
                </h1>
                <div className="flex w-full gap-[15px] items-end mt-[48px]">
                  ...
                  <div className="border-b-[1px] border-[#A5A5A5] text-[15px] w-full">
                    Do Homework
                  </div>
                </div>
                <div className="flex w-full gap-[15px] items-end mt-[48px]">
